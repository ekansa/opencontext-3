...
Please refer to this project's overview in Open Context at <http://opencontext.org/projects/3> for more information on licensing and how to cite these data.

NOTE: This GitHub repository supercedes data originally provided at <https://github.com/ekansa/Open-Context-Data/tree/master/data/3>. The original repository grew too large, so we created new repositories for each Open Context project/collection.
